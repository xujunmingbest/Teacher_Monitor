...
namespace 教师机监控台 {
	...
	/// 总电源第三组 摘要
	/// </summary>
	public ref class 总电源第三组 : public DockContent
	{
	public:
		总电源第三组(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button12->Click += gcnew System::EventHandler(this, &总电源第三组::button12_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &总电源第三组::button13_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &总电源第三组::button14_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &总电源第三组::button15_Click);
			// 
			// button16
			// 
			...
			this->button16->Click += gcnew System::EventHandler(this, &总电源第三组::button16_Click);
			// 
			// button17
			// 
			...
			this->button17->Click += gcnew System::EventHandler(this, &总电源第三组::button17_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &总电源第三组::button6_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &总电源第三组::button7_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &总电源第三组::button8_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &总电源第三组::button9_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &总电源第三组::button4_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &总电源第三组::button5_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &总电源第三组::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &总电源第三组::button2_Click);
			// 
			// label5
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &总电源第三组::button1_Click);
			// 
			// label2
			// 
