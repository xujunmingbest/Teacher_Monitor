...
namespace 教师机监控台 {
	...
	/// 直流电源2 摘要
	/// </summary>
	public ref class 直流电源2 : public System::Windows::Forms::Form
	{
	public:
		直流电源2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Location = System::Drawing::Point(29, 64);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(780, 415);
			this->panel1->TabIndex = 3;
			this->panel1->Click += gcnew System::EventHandler(this, &直流电源2::panel1_Click);
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &直流电源2::panel1_Paint);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &直流电源2::button11_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &直流电源2::button12_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &直流电源2::button13_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &直流电源2::button14_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &直流电源2::button15_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &直流电源2::button6_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &直流电源2::button7_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &直流电源2::button8_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &直流电源2::button9_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &直流电源2::button10_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &直流电源2::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &直流电源2::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &直流电源2::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &直流电源2::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &直流电源2::button1_Click);
			// 
			// textBox_A_ALL
			// 
			...
			this->label1->Text = L"直流电源2控制";
			// 
			// 直流电源2
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 15);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(906, 556);
			this->Controls->Add(this->panel1);
			this->Name = L"直流电源2";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"直流电源2";
			this->Load += gcnew System::EventHandler(this, &直流电源2::直流电源2_Load);
...
private: System::Void 直流电源2_Load(System::Object^  sender, System::EventArgs^  e) {
}
};
}
